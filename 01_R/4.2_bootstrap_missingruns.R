...
path_to_output <- paste0("/u/home/y/yixzhou/AA_stroke_dem/results_missingruns/")
...
scenario_lookup <- read_csv(
  # here("01_R", "bootstrap_scenarios_missing.csv") # laptop
  paste0(data_folder, "bootstrap_scenarios_missing.csv") # Hoffman
)
...
# only running missing scenarios for this group
ethns_list <- c("White")
